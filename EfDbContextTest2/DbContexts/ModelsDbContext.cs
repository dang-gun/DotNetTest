...
/// 공통 컨택스트
/// </summary>
public class ModelsDbContext: ModelsDbContextModel
{
...
#pragma warning disable CS8618 // 생성자를 종료할 때 null을 허용하지 않는 필드에 null이 아닌 값을 포함해야 합니다. null 허용으로 선언해 보세요.
	...
	public ModelsDbContext(DbContextOptions<DbContext> options)
        : base(options)
	{
        Debug.WriteLine(" ◇ ◇ ◇ ◇ 생성자 있음");
